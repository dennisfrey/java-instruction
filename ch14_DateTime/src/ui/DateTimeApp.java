...
public class DateTimeApp {
	...
	public static void main(String[] args) {
		System.out.println("Create som edates/times...");
		...
		System.out.println("now isafter Christmas??? " + now1.isBefore(christmas));
		...
		System.out.println("Add/Subtracting Time");
		LocalDate nowPlus3Weeks = now1.plus(3,ChronoUnit.WEEKS);
		System.out.println("3 weeks form now... "+ nowPlus3Weeks);
		...
		System.out.println("curent date in full format: " + formatter.format(now1));
